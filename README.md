...
Welcome to my implementation of the AI Voice Agents Challenge by murf.ai!
...
🚀 Tech Stack
Voice Infrastructure: LiveKit Agents - Real-time voice framework
Speech-to-Text: Deepgram Nova-3 - High-accuracy transcription (80-250ms)
Language Model: Google Gemini 2.5 Flash - Fast, intelligent responses (100-500ms)
Text-to-Speech: Murf Falcon - Ultra-fast, natural voice (50-150ms) ⚡
...
Start speaking: "Hello, can you hear me?"
Watch the magic happen! ✨
📚 Complete Documentation
Document	Description	Use Case
START_HERE.md	Beginner-friendly setup guide	First-time users
SETUP_GUIDE.md	Comprehensive installation	Detailed configuration
QUICK_START.md	Rapid deployment	Get running fast
TESTING_INSTRUCTIONS.md	Testing procedures	Validate your setup
PIPELINE_ANALYSIS.md	Performance metrics	Optimization insights
DAY_1_README.md	Day 1 journey	Challenge completion
PROJECT_ORGANIZATION.md	Repo structure	Understanding layout
...
See PIPELINE_ANALYSIS.md for detailed breakdown.
...
Verify Deepgram API key in backend/.env.local
Check backend logs for "STT transcript:" messages
...
Google Gemini API
Original Templates
LiveKit Python Agent Starter
LiveKit React Frontend Starter
...
cd backend
uv run pytest
Learn more: LiveKit Agent Testing Documentation
...
Original repository: murf-ai/ten-days-of-voice-agents-2025
🎯 What's Next?
